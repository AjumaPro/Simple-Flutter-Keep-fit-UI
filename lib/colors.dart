...
class AppColor{
  ...
  static Color homePageTopIconColor=const Color(0xFFb7bce8);
  static Color homePageTitleColor=const Color(0xFFfefeff);
  static Color secondPageContainerGradient1stColor=const Color(0xff0f88e8);
  static Color secondPageContainerGradient2ndColor=const Color(0xFF1f88e8);
  static Color secondPageIconColor=const Color(0xFFfefeff);
